...
convergence_studies/convergence_2d.cxx, comparing the Becke and Treutler-Ahlrichs (TA)
...
Usage:
    python convergence_studies/plot_convergence_2d.py [convergence_2d.csv]
"""
...
def main():
    ...
    if not csv_path.exists():
        raise SystemExit(
            ...
            "Run the sweep first (e.g. build/convergence_studies/convergence_2d), then pass "
