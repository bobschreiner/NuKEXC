\begin{table}[H]
  ...
  \begin{tabular}{@{}rrrlllll@{}}
    ...
    \bottomrule
  \end{tabular}
  \caption{Per-term convergence data of the water angular-pruning study (Figures~\ref{fig:conv_pruning_total} and~\ref{fig:conv_pruning_terms}): absolute errors of the kinetic, nuclear-attraction, Coulomb, exchange and total unrestricted Hartree--Fock energies. Reference: uniform unpruned grid with $n_\mathrm{rad}=1000$, $L=50$ (2,917,774 points), $E_\mathrm{kin}=75.9976267410$~$E_\mathrm{h}$, $E_\mathrm{ne}=-199.0472994426$~$E_\mathrm{h}$, $E_J=46.7402184304$~$E_\mathrm{h}$, $E_K=-8.9450726577$~$E_\mathrm{h}$, $E_\mathrm{scf}=-76.0667767173$~$E_\mathrm{h}$.}
