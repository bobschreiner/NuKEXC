\begin{table}[H]
  ...
  \begin{tabular}{@{}rllllll@{}}
    ...
    \bottomrule
  \end{tabular}
  \caption{H$_2^+$ two-dimensional grid-convergence data, Becke radial scheme (Figure~\ref{fig:conv_2d}): $|E-E_\mathrm{ref}|$ in Ha for every combination of $n_\mathrm{rad}$ and angular order $L$.}
