\begin{table}[H]
  ...
  \begin{tabular}{@{}rrlll@{}}
    ...
    \bottomrule
  \end{tabular}
  \caption{Radial-grid convergence data of the hydrogen-atom study (Figure~\ref{fig:conv_radial_h}). Absolute error of the core-Hamiltonian lowest-MO energy per radial scheme, measured against the exact non-relativistic $1s$ energy $E_\mathrm{exact}=-0.5$~Ha.}
