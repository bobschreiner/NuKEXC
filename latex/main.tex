...
stays nearly constant across the four bases, at roughly $0.55$ to
...
opposite way. It grows from $0.1$~s per molecule at DZ to $4.23$~s at
...
deviation from \( 53.1 \) to \( 390 \)~kcal/mol and leaves a residual
mean signed deviation of \( -2.7 \)~kcal/mol that reflects the
