...
libraries}~\cite{Lehtola2023c}, in which he argue that open source
...
available reusable implementations. TODO: cite
...
\begin{equation}
  I_n = \int_{S^2}\int_0^{\infty} F_n(r,\Omega)r^2  \mathrm dr \, \mathrm d\Omega,
  \label{eq:I_solid}
\end{equation}
