...
energies of small second row molecules. The reference values
...
SCF is converged to a DIIS error of $10^{-6}$. All
...
the superposition of atomic potentials (SAP) \cite{} helped but still
...
improves from $53.1$~kcal/mol at DZ to $7.7$~kcal/mol at TZP,
$4.3$~kcal/mol at TZ2P and
$3.9$~kcal/mol at QZ4P. The DZ basis carries no polarization
functions at all
...
deviation of $-2.7$~kcal/mol rather than at zero. This residual is the
...
energies \cite{}. We take the agreement of this progression with the published
...
\begin{figure}[H]
  ...
  \caption{Distribution of the signed error in the W4-11 total
    ...
    unrestricted B3LYP (\texttt{Libxc}~\cite{Lehtola2018libxc}
      \texttt{hyb\_gga\_xc\_b3lyp3} \cite{}, the VWN3
...
\section*{AI transparency}\label{sec:AI tranparency}
...
\begin{table}[H]
  ...
  {\small
    \begin{tabular}{@{}l l l l@{}}
      ...
      Plotting of Figures & Claude  Opus 5 & all figures & Plotting
      scripts in python manually polished \\
      Tables & Claude  Opus 5 & all tables & Tables are generated
      from csv files  \\
      Derivation of unrestriced xc gga kernel
      & Claude  Opus 5 & section \ref{subsubsec:dense_la_xc}  &
      Formulas were rederived by hand \\
      Debugging of C++ code & Claude Opus 5 & all codes & --- \\
      \bottomrule
  \end{tabular}}
