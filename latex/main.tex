...
This section contains the results of our implementations.
We analyze convergence as well as timing results, starting with
preliminary studies on small example systems and then
later performing full benchmarks on the W4-11 set of Karton, Daon and
...
roughly \( 10^{-15} \)~Ha. The full data is tabulated in
Table~\ref{tab:data_radial_h}.
...
\begin{figure}[htbp]
  ...
  \caption{We compute the lowest-MO energy of a single hydrogen atom
    ...
    As out basis set we chose QZ4P (ADF Slater-type).
...
\begin{table}[H]
  ...
  \caption{Summary of the W4-11 B3LYP atomization energy errors per
    ...
    of Fock builds and would inflate the mean by up to $56\%$. Systems,
