...
tests/convergence_radial_h.cxx: Becke vs Treutler-Ahlrichs M3 vs TA-M4 on a
...
Usage:
    python tests/plot_radial_h.py [convergence_radial_h.csv]
"""
...
def main():
    ...
    if not csv_path.exists():
        raise SystemExit(
            ...
            "Run the study first (build/tests/convergence_radial_h), then pass "
