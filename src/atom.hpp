...
/**
 *  @brief A struct to represent the state of an atom (charge and spacial
 * location)
 */
struct Atom {
   ...
   */
  Atom(int _Z, double _x, double _y, double _z) : Z(_Z), x(_x), y(_y), z(_z) {}
 ...
 *             true otherwise
 */
inline bool operator!=(const Atom &a1, const Atom &a2) { return not(a1 == a2); }
